...
import (
	...
	traceparser "github.com/conprof/conprof/internal/trace"
)
...
func parseTrace() (traceparser.ParseResult, error) {
	loader.once.Do(func() {
		...
		// Parse and symbolize.
		res, err := traceparser.Parse(bufio.NewReader(tracef), programBinary)
		if err != nil {
...
func TestAnalyzeAnnotations(t *testing.T) {
	...
	res, err := analyzeAnnotations(loader.res)
	if err != nil {
