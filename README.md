...
Flags:
  -h, --help                      Show context-sensitive help.
      ...
      --enable-persistence        Turn on persistent storage for the local
                                  metastore (profile data is stored in
                                  ClickHouse regardless).
      --storage-path="data"       Path to storage directory used for the local
                                  metastore.
