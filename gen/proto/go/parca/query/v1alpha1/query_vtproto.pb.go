...
func (m *QueryRangeRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Step != nil {
		if vtmsg, ok := interface{}(m.Step).(interface {
			...
			encoded, err := proto.Marshal(m.Step)
			if err != nil {
				return 0, err
			}
			i -= len(encoded)
...
func (m *QueryRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.StackPrefix != nil {
		size, err := m.StackPrefix.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *StackPrefix) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *StackPrefix) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *StackPrefix) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if len(m.StackFrames) > 0 {
		for iNdEx := len(m.StackFrames) - 1; iNdEx >= 0; iNdEx-- {
			size, err := m.StackFrames[iNdEx].MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *StackFrame) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.StartLineNumber != 0 {
		i = encodeVarint(dAtA, i, uint64(m.StartLineNumber))
		i--
		dAtA[i] = 0x38
	}
	if m.LineNumber != 0 {
	...
	if len(m.MappingFile) > 0 {
		i -= len(m.MappingFile)
		copy(dAtA[i:], m.MappingFile)
		i = encodeVarint(dAtA, i, uint64(len(m.MappingFile)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.BuildId) > 0 {
...
func (m *GroupBy) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.Fields) > 0 {
		for iNdEx := len(m.Fields) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarint(dAtA, i, uint64(len(m.Fields[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *FlamegraphArrow) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.Record) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.Record)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *QueryRangeRequest) SizeVT() (n int) {
	...
	if m.Step != nil {
		if size, ok := interface{}(m.Step).(interface {
			SizeVT() int
		}); ok {
			l = size.SizeVT()
		} else {
...
func (m *StackPrefix) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StackFrame) SizeVT() (n int) {
	...
	if m.StartLineNumber != 0 {
		n += 1 + sov(uint64(m.StartLineNumber))
	}
	n += len(m.unknownFields)
	return n
}
...
func (m *QueryRangeRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			if m.Step == nil {
				m.Step = &durationpb.Duration{}
			}
			if unmarshal, ok := interface{}(m.Step).(interface {
				UnmarshalVT([]byte) error
			}); ok {
				if err := unmarshal.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				...
				if err := proto.Unmarshal(dAtA[iNdEx:postIndex], m.Step); err != nil {
					return err
				}
			}
			iNdEx = postIndex
...
func (m *QueryRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field StackPrefix", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.StackPrefix == nil {
				m.StackPrefix = &StackPrefix{}
			}
			if err := m.StackPrefix.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *StackPrefix) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: StackPrefix: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: StackPrefix: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			if err := m.StackFrames[len(m.StackFrames)-1].UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *StackFrame) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MappingFile", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MappingFile = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field StartLineNumber", wireType)
			}
			m.StartLineNumber = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.StartLineNumber |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
