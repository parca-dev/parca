...
type QueryResponse_Flamegraph struct {
	...
	Flamegraph *v1alpha1.Flamegraph `protobuf:"bytes,5,opt,name=flamegraph,proto3,oneof"`
}
...
type QueryResponse_Top struct {
	...
	Top *v1alpha1.Top `protobuf:"bytes,7,opt,name=top,proto3,oneof"`
}

type QueryResponse_Callgraph struct {
	// callgraph is a callgraph nodes and edges representation of the report
	Callgraph *v1alpha1.Callgraph `protobuf:"bytes,8,opt,name=callgraph,proto3,oneof"`
}
