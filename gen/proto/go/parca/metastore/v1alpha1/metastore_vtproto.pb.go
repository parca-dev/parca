...
func (m *UnsymbolizedLocationsRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.MinKey) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.MinKey)))
		i--
		dAtA[i] = 0x12
	}
	if m.Limit != 0 {
...
func (m *UnsymbolizedLocationsResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.MaxKey) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.MaxKey)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Locations) > 0 {
...
func (m *StacktracesRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.StacktraceIds) > 0 {
		for iNdEx := len(m.StacktraceIds) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.StacktraceIds[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *LocationsRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.LocationIds) > 0 {
		for iNdEx := len(m.LocationIds) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.LocationIds[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *FunctionsRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.FunctionIds) > 0 {
		for iNdEx := len(m.FunctionIds) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.FunctionIds[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *MappingsRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.MappingIds) > 0 {
		for iNdEx := len(m.MappingIds) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.MappingIds[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *Sample) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.StacktraceId) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.StacktraceId)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *SampleNumUnit) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.Units) > 0 {
		for iNdEx := len(m.Units) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.Units[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *Location) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.MappingId) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.MappingId)))
		i--
		dAtA[i] = 0x22
	}
	if m.Address != 0 {
...
func (m *Line) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.FunctionId) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.FunctionId)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *Function) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.FilenameStringIndex != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.FilenameStringIndex))
		i--
		dAtA[i] = 0x40
	}
	if m.SystemNameStringIndex != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.SystemNameStringIndex))
		i--
		dAtA[i] = 0x38
	}
	if m.NameStringIndex != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.NameStringIndex))
		i--
		dAtA[i] = 0x30
	}
	if len(m.Filename) > 0 {
...
func (m *Mapping) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.BuildIdStringIndex != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.BuildIdStringIndex))
		i--
		dAtA[i] = 0x60
	}
	if m.FileStringIndex != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.FileStringIndex))
		i--
		dAtA[i] = 0x58
	}
...
func (m *Function) SizeVT() (n int) {
	...
	if m.NameStringIndex != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.NameStringIndex))
	}
	if m.SystemNameStringIndex != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.SystemNameStringIndex))
	}
	if m.FilenameStringIndex != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.FilenameStringIndex))
	}
	n += len(m.unknownFields)
	return n
}
...
func (m *Mapping) SizeVT() (n int) {
	...
	if m.FileStringIndex != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.FileStringIndex))
	}
	if m.BuildIdStringIndex != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.BuildIdStringIndex))
	}
	n += len(m.unknownFields)
	return n
}
