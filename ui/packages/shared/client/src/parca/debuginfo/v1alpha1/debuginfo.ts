...
class ShouldInitiateUploadRequest$Type extends MessageType<ShouldInitiateUploadRequest> {
  ...
  internalBinaryRead(
    ...
    target?: ShouldInitiateUploadRequest
  ...
  internalBinaryWrite(
    ...
    /* string build_id = 1; */
    if (message.buildId !== '') writer.tag(1, WireType.LengthDelimited).string(message.buildId);
    /* string hash = 2; */
    if (message.hash !== '') writer.tag(2, WireType.LengthDelimited).string(message.hash);
...
class ShouldInitiateUploadResponse$Type extends MessageType<ShouldInitiateUploadResponse> {
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: ShouldInitiateUploadResponse
...
class InitiateUploadRequest$Type extends MessageType<InitiateUploadRequest> {
  ...
  create(value?: PartialMessage<InitiateUploadRequest>): InitiateUploadRequest {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {enumerable: false, value: this});
    if (value !== undefined) reflectionMergePartial<InitiateUploadRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(
    ...
    if (message.buildId !== '') writer.tag(1, WireType.LengthDelimited).string(message.buildId);
    /* int64 size = 2; */
    if (message.size !== '0') writer.tag(2, WireType.Varint).int64(message.size);
    /* string hash = 3; */
    if (message.hash !== '') writer.tag(3, WireType.LengthDelimited).string(message.hash);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class InitiateUploadResponse$Type extends MessageType<InitiateUploadResponse> {
  ...
  create(value?: PartialMessage<InitiateUploadResponse>): InitiateUploadResponse {
    const message = {};
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {enumerable: false, value: this});
    if (value !== undefined) reflectionMergePartial<InitiateUploadResponse>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* parca.debuginfo.v1alpha1.UploadInstructions upload_instructions */ 1:
          message.uploadInstructions = UploadInstructions.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
  ...
  internalBinaryWrite(
    ...
    if (message.uploadInstructions)
      UploadInstructions.internalBinaryWrite(
        message.uploadInstructions,
...
class UploadInstructions$Type extends MessageType<UploadInstructions> {
  constructor() {
    super('parca.debuginfo.v1alpha1.UploadInstructions', [
      ...
      {no: 2, name: 'upload_id', kind: 'scalar', T: 9 /*ScalarType.STRING*/},
      {
        ...
        kind: 'enum',
        T: () => [
          'parca.debuginfo.v1alpha1.UploadInstructions.UploadStrategy',
  ...
  create(value?: PartialMessage<UploadInstructions>): UploadInstructions {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {enumerable: false, value: this});
    if (value !== undefined) reflectionMergePartial<UploadInstructions>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(
    ...
    if (message.buildId !== '') writer.tag(1, WireType.LengthDelimited).string(message.buildId);
    /* string upload_id = 2; */
    if (message.uploadId !== '') writer.tag(2, WireType.LengthDelimited).string(message.uploadId);
    /* parca.debuginfo.v1alpha1.UploadInstructions.UploadStrategy upload_strategy = 3; */
    if (message.uploadStrategy !== 0) writer.tag(3, WireType.Varint).int32(message.uploadStrategy);
    /* string signed_url = 4; */
    if (message.signedUrl !== '') writer.tag(4, WireType.LengthDelimited).string(message.signedUrl);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class MarkUploadFinishedRequest$Type extends MessageType<MarkUploadFinishedRequest> {
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: MarkUploadFinishedRequest
...
class MarkUploadFinishedResponse$Type extends MessageType<MarkUploadFinishedResponse> {
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: MarkUploadFinishedResponse
...
class UploadRequest$Type extends MessageType<UploadRequest> {
  ...
  create(value?: PartialMessage<UploadRequest>): UploadRequest {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {enumerable: false, value: this});
    if (value !== undefined) reflectionMergePartial<UploadRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* parca.debuginfo.v1alpha1.UploadInfo info */ 1:
          message.data = {
            oneofKind: 'info',
            info: UploadInfo.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.data as any).info
            ),
          };
          break;
  ...
  internalBinaryWrite(
    ...
    if (message.data.oneofKind === 'info')
      UploadInfo.internalBinaryWrite(
        message.data.info,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options
      ).join();
...
class UploadInfo$Type extends MessageType<UploadInfo> {
  ...
  create(value?: PartialMessage<UploadInfo>): UploadInfo {
    const message = {buildId: '', uploadId: ''};
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {enumerable: false, value: this});
    if (value !== undefined) reflectionMergePartial<UploadInfo>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class UploadResponse$Type extends MessageType<UploadResponse> {
  ...
  internalBinaryWrite(
    ...
    if (message.buildId !== '') writer.tag(1, WireType.LengthDelimited).string(message.buildId);
    /* uint64 size = 2; */
    if (message.size !== '0') writer.tag(2, WireType.Varint).uint64(message.size);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class Debuginfo$Type extends MessageType<Debuginfo> {
  constructor() {
    super('parca.debuginfo.v1alpha1.Debuginfo', [
      {no: 1, name: 'build_id', kind: 'scalar', T: 9 /*ScalarType.STRING*/},
      {
        ...
        name: 'source',
        kind: 'enum',
        T: () => ['parca.debuginfo.v1alpha1.Debuginfo.Source', Debuginfo_Source, 'SOURCE_'],
      },
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* parca.debuginfo.v1alpha1.DebuginfoUpload upload */ 3:
          message.upload = DebuginfoUpload.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.upload
        ...
        case /* parca.debuginfo.v1alpha1.DebuginfoQuality quality */ 4:
          message.quality = DebuginfoQuality.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.quality
  ...
  internalBinaryWrite(
    ...
    if (message.source !== 0) writer.tag(2, WireType.Varint).int32(message.source);
    /* parca.debuginfo.v1alpha1.DebuginfoUpload upload = 3; */
    if (message.upload)
      DebuginfoUpload.internalBinaryWrite(
        message.upload,
    ...
    if (message.quality)
      DebuginfoQuality.internalBinaryWrite(
        message.quality,
...
class DebuginfoUpload$Type extends MessageType<DebuginfoUpload> {
  constructor() {
    super('parca.debuginfo.v1alpha1.DebuginfoUpload', [
      ...
      {no: 2, name: 'hash', kind: 'scalar', T: 9 /*ScalarType.STRING*/},
      {
        ...
        kind: 'enum',
        T: () => [
          'parca.debuginfo.v1alpha1.DebuginfoUpload.State',
  ...
  create(value?: PartialMessage<DebuginfoUpload>): DebuginfoUpload {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {enumerable: false, value: this});
    if (value !== undefined) reflectionMergePartial<DebuginfoUpload>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class DebuginfoQuality$Type extends MessageType<DebuginfoQuality> {
  ...
  create(value?: PartialMessage<DebuginfoQuality>): DebuginfoQuality {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {enumerable: false, value: this});
    if (value !== undefined) reflectionMergePartial<DebuginfoQuality>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(
    ...
    if (message.notValidElf !== false) writer.tag(1, WireType.Varint).bool(message.notValidElf);
    /* bool has_dwarf = 2; */
    if (message.hasDwarf !== false) writer.tag(2, WireType.Varint).bool(message.hasDwarf);
    /* bool has_go_pclntab = 3; */
    if (message.hasGoPclntab !== false) writer.tag(3, WireType.Varint).bool(message.hasGoPclntab);
    /* bool has_symtab = 4; */
    if (message.hasSymtab !== false) writer.tag(4, WireType.Varint).bool(message.hasSymtab);
    /* bool has_dynsym = 5; */
    if (message.hasDynsym !== false) writer.tag(5, WireType.Varint).bool(message.hasDynsym);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
