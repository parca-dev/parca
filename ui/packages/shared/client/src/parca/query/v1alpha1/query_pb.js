...
proto.parca.query.v1alpha1.Flamegraph.toObject = function(includeInstance, msg) {
  var f, obj = {
    root: (f = msg.getRoot()) && proto.parca.query.v1alpha1.FlamegraphNode.toObject(includeInstance, f),
...
proto.parca.query.v1alpha1.Flamegraph.prototype.getRoot = function() {
  return /** @type{?proto.parca.query.v1alpha1.FlamegraphNode} */ (
    jspb.Message.getWrapperField(this, proto.parca.query.v1alpha1.FlamegraphNode, 1));
};


/**
 * @param {?proto.parca.query.v1alpha1.FlamegraphNode|undefined} value
 ...
 * @const
 */
proto.parca.query.v1alpha1.FlamegraphNode.repeatedFields_ = [5];
 ...
 * @return {string}
 */
proto.parca.query.v1alpha1.FlamegraphNode.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 */
proto.parca.query.v1alpha1.FlamegraphNode.prototype.setName = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.parca.query.v1alpha1.FlamegraphNode.prototype.getFullName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.parca.query.v1alpha1.FlamegraphNode} returns this
 */
proto.parca.query.v1alpha1.FlamegraphNode.prototype.setFullName = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
...
proto.parca.query.v1alpha1.FlamegraphNode.prototype.getChildrenList = function() {
  return /** @type{!Array<!proto.parca.query.v1alpha1.FlamegraphNode>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.parca.query.v1alpha1.FlamegraphNode, 5));
};
...
proto.parca.query.v1alpha1.FlamegraphNode.prototype.addChildren = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 5, opt_value, proto.parca.query.v1alpha1.FlamegraphNode, opt_index);
};
 ...
 * @const
 */
proto.parca.query.v1alpha1.LabelsResponse.repeatedFields_ = [1];
 ...
 * @const
 */
proto.parca.query.v1alpha1.ValuesResponse.repeatedFields_ = [1];
