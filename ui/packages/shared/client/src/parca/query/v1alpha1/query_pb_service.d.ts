...
export class QueryServiceClient {
  ...
  queryRange(
    ...
    callback: (
      ...
      responseMessage: parca_query_v1alpha1_query_pb.QueryRangeResponse | null
    ) => void
  ): UnaryResponse;
  queryRange(
    requestMessage: parca_query_v1alpha1_query_pb.QueryRangeRequest,
  ...
  series(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: parca_query_v1alpha1_query_pb.SeriesResponse | null
    ) => void
  ): UnaryResponse;
  series(
    requestMessage: parca_query_v1alpha1_query_pb.SeriesRequest,
  ...
  labels(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: parca_query_v1alpha1_query_pb.LabelsResponse | null
    ) => void
  ): UnaryResponse;
  labels(
    requestMessage: parca_query_v1alpha1_query_pb.LabelsRequest,
  ...
  values(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: parca_query_v1alpha1_query_pb.ValuesResponse | null
    ) => void
  ): UnaryResponse;
  values(
    requestMessage: parca_query_v1alpha1_query_pb.ValuesRequest,
