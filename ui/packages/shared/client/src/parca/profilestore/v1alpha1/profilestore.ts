...
class WriteRawRequest$Type extends MessageType<WriteRawRequest> {
  ...
  create(value?: PartialMessage<WriteRawRequest>): WriteRawRequest {
    ...
    if (value !== undefined) reflectionMergePartial<WriteRawRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated parca.profilestore.v1alpha1.RawProfileSeries series */ 2:
          message.series.push(
            RawProfileSeries.internalBinaryRead(reader, reader.uint32(), options)
          );
          break;
  ...
  internalBinaryWrite(
    ...
    if (message.tenant !== '') writer.tag(1, WireType.LengthDelimited).string(message.tenant);
    /* repeated parca.profilestore.v1alpha1.RawProfileSeries series = 2; */
    for (let i = 0; i < message.series.length; i++)
      RawProfileSeries.internalBinaryWrite(
        message.series[i],
        writer.tag(2, WireType.LengthDelimited).fork(),
        options
      ).join();
    /* bool normalized = 3; */
    if (message.normalized !== false) writer.tag(3, WireType.Varint).bool(message.normalized);
...
class WriteRawResponse$Type extends MessageType<WriteRawResponse> {
  ...
  create(value?: PartialMessage<WriteRawResponse>): WriteRawResponse {
    const message = {};
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {enumerable: false, value: this});
    if (value !== undefined) reflectionMergePartial<WriteRawResponse>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class RawProfileSeries$Type extends MessageType<RawProfileSeries> {
  ...
  create(value?: PartialMessage<RawProfileSeries>): RawProfileSeries {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {enumerable: false, value: this});
    if (value !== undefined) reflectionMergePartial<RawProfileSeries>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* parca.profilestore.v1alpha1.LabelSet labels */ 1:
          message.labels = LabelSet.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.labels
...
class LabelSet$Type extends MessageType<LabelSet> {
  ...
  create(value?: PartialMessage<LabelSet>): LabelSet {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {enumerable: false, value: this});
    if (value !== undefined) reflectionMergePartial<LabelSet>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class RawSample$Type extends MessageType<RawSample> {
  ...
  create(value?: PartialMessage<RawSample>): RawSample {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {enumerable: false, value: this});
    if (value !== undefined) reflectionMergePartial<RawSample>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class AgentsRequest$Type extends MessageType<AgentsRequest> {
  ...
  create(value?: PartialMessage<AgentsRequest>): AgentsRequest {
    const message = {};
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {enumerable: false, value: this});
    if (value !== undefined) reflectionMergePartial<AgentsRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class AgentsResponse$Type extends MessageType<AgentsResponse> {
  ...
  create(value?: PartialMessage<AgentsResponse>): AgentsResponse {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {enumerable: false, value: this});
    if (value !== undefined) reflectionMergePartial<AgentsResponse>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class Agent$Type extends MessageType<Agent> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* google.protobuf.Timestamp last_push */ 3:
          message.lastPush = Timestamp.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.lastPush
        ...
        case /* google.protobuf.Duration last_push_duration */ 4:
          message.lastPushDuration = Duration.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.lastPushDuration
          );
          break;
        default:
          let u = options.readUnknownField;
  ...
  internalBinaryWrite(
    ...
    /* string last_error = 2; */
    if (message.lastError !== '') writer.tag(2, WireType.LengthDelimited).string(message.lastError);
 ...
 */
export const ProfileStoreService = new ServiceType(
  'parca.profilestore.v1alpha1.ProfileStoreService',
  [
    {
      name: 'WriteRaw',
      options: {'google.api.http': {post: '/profiles/writeraw', body: '*'}},
      I: WriteRawRequest,
      O: WriteRawResponse,
    },
  ]
...
export const AgentsService = new ServiceType('parca.profilestore.v1alpha1.AgentsService', [
  {
    name: 'Agents',
    options: {'google.api.http': {get: '/agents'}},
    I: AgentsRequest,
    O: AgentsResponse,
  },
]);
