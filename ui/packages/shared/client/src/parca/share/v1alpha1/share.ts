...
class UploadRequest$Type extends MessageType<UploadRequest> {
  ...
  internalBinaryWrite(
    ...
    /* bytes profile = 1; */
    if (message.profile.length) writer.tag(1, WireType.LengthDelimited).bytes(message.profile);
...
class UploadResponse$Type extends MessageType<UploadResponse> {
  ...
  internalBinaryWrite(
    ...
    /* string link = 2; */
    if (message.link !== '') writer.tag(2, WireType.LengthDelimited).string(message.link);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class QueryRequest$Type extends MessageType<QueryRequest> {
  ...
  internalBinaryWrite(
    ...
    if (message.reportType !== 0) writer.tag(3, WireType.Varint).int32(message.reportType);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
