...
class TargetsRequest$Type extends MessageType<TargetsRequest> {
    ...
    super('parca.scrape.v1alpha1.TargetsRequest', [
      {
        ...
        name: 'state',
        kind: 'enum',
        T: () => ['parca.scrape.v1alpha1.TargetsRequest.State', TargetsRequest_State, 'STATE_'],
      },
    ]);
  }
  create(value?: PartialMessage<TargetsRequest>): TargetsRequest {
    ...
    if (value !== undefined) reflectionMergePartial<TargetsRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
...
class TargetsResponse$Type extends MessageType<TargetsResponse> {
  ...
  create(value?: PartialMessage<TargetsResponse>): TargetsResponse {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {enumerable: false, value: this});
    if (value !== undefined) reflectionMergePartial<TargetsResponse>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  private binaryReadMap1(
    map: TargetsResponse['targets'],
    reader: IBinaryReader,
    options: BinaryReadOptions
  ): void {
    let len = reader.uint32(),
      end = reader.pos + len,
      key: keyof TargetsResponse['targets'] | undefined,
      val: TargetsResponse['targets'][any] | undefined;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case 1:
        ...
        default:
          throw new globalThis.Error(
            'unknown map entry field for field parca.scrape.v1alpha1.TargetsResponse.targets'
          );
      }
    }
...
class Targets$Type extends MessageType<Targets> {
  ...
  create(value?: PartialMessage<Targets>): Targets {
    const message = {targets: []};
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {enumerable: false, value: this});
    if (value !== undefined) reflectionMergePartial<Targets>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class Target$Type extends MessageType<Target> {
  constructor() {
    super('parca.scrape.v1alpha1.Target', [
      ...
      {no: 6, name: 'url', kind: 'scalar', T: 9 /*ScalarType.STRING*/},
      {
        ...
        name: 'health',
        kind: 'enum',
        T: () => ['parca.scrape.v1alpha1.Target.Health', Target_Health, 'HEALTH_'],
      },
    ]);
  }
  create(value?: PartialMessage<Target>): Target {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {enumerable: false, value: this});
    if (value !== undefined) reflectionMergePartial<Target>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* parca.profilestore.v1alpha1.LabelSet discovered_labels */ 1:
          message.discoveredLabels = LabelSet.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.discoveredLabels
          );
          break;
        ...
        case /* google.protobuf.Timestamp last_scrape */ 4:
          message.lastScrape = Timestamp.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.lastScrape
        ...
        case /* google.protobuf.Duration last_scrape_duration */ 5:
          message.lastScrapeDuration = Duration.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.lastScrapeDuration
          );
          break;
        case /* string url */ 6:
  ...
  internalBinaryWrite(
    ...
    /* string last_error = 3; */
    if (message.lastError !== '') writer.tag(3, WireType.LengthDelimited).string(message.lastError);
    ...
    if (message.health !== 0) writer.tag(7, WireType.Varint).int32(message.health);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
export const ScrapeService = new ServiceType('parca.scrape.v1alpha1.ScrapeService', [
  {
    name: 'Targets',
    options: {'google.api.http': {get: '/targets'}},
    I: TargetsRequest,
    O: TargetsResponse,
  },
]);
