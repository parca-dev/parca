...
class GetOrCreateMappingsRequest$Type extends MessageType<GetOrCreateMappingsRequest> {
  ...
  internalBinaryRead(
    ...
    target?: GetOrCreateMappingsRequest
...
class GetOrCreateMappingsResponse$Type extends MessageType<GetOrCreateMappingsResponse> {
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GetOrCreateMappingsResponse
  ): GetOrCreateMappingsResponse {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
...
class GetOrCreateFunctionsRequest$Type extends MessageType<GetOrCreateFunctionsRequest> {
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GetOrCreateFunctionsRequest
  ): GetOrCreateFunctionsRequest {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
...
class GetOrCreateFunctionsResponse$Type extends MessageType<GetOrCreateFunctionsResponse> {
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GetOrCreateFunctionsResponse
  ): GetOrCreateFunctionsResponse {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
...
class GetOrCreateLocationsRequest$Type extends MessageType<GetOrCreateLocationsRequest> {
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GetOrCreateLocationsRequest
...
class GetOrCreateLocationsResponse$Type extends MessageType<GetOrCreateLocationsResponse> {
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GetOrCreateLocationsResponse
  ): GetOrCreateLocationsResponse {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
...
class GetOrCreateStacktracesRequest$Type extends MessageType<GetOrCreateStacktracesRequest> {
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GetOrCreateStacktracesRequest
  ): GetOrCreateStacktracesRequest {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.stacktraces.length; i++)
      Stacktrace.internalBinaryWrite(
        message.stacktraces[i],
        writer.tag(1, WireType.LengthDelimited).fork(),
        options
      ).join();
    let u = options.writeUnknownFields;
...
class GetOrCreateStacktracesResponse$Type extends MessageType<GetOrCreateStacktracesResponse> {
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GetOrCreateStacktracesResponse
  ): GetOrCreateStacktracesResponse {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
...
class UnsymbolizedLocationsRequest$Type extends MessageType<UnsymbolizedLocationsRequest> {
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: UnsymbolizedLocationsRequest
  ): UnsymbolizedLocationsRequest {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
  ...
  internalBinaryWrite(
    ...
    /* uint32 limit = 1; */
    if (message.limit !== 0) writer.tag(1, WireType.Varint).uint32(message.limit);
    /* string min_key = 2; */
    if (message.minKey !== '') writer.tag(2, WireType.LengthDelimited).string(message.minKey);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class UnsymbolizedLocationsResponse$Type extends MessageType<UnsymbolizedLocationsResponse> {
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: UnsymbolizedLocationsResponse
  ...
  internalBinaryWrite(
    ...
    /* string max_key = 2; */
    if (message.maxKey !== '') writer.tag(2, WireType.LengthDelimited).string(message.maxKey);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class CreateLocationLinesRequest$Type extends MessageType<CreateLocationLinesRequest> {
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: CreateLocationLinesRequest
  ): CreateLocationLinesRequest {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
...
class CreateLocationLinesResponse$Type extends MessageType<CreateLocationLinesResponse> {
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: CreateLocationLinesResponse
...
class StacktracesRequest$Type extends MessageType<StacktracesRequest> {
  ...
  create(value?: PartialMessage<StacktracesRequest>): StacktracesRequest {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {enumerable: false, value: this});
    if (value !== undefined) reflectionMergePartial<StacktracesRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class StacktracesResponse$Type extends MessageType<StacktracesResponse> {
  ...
  create(value?: PartialMessage<StacktracesResponse>): StacktracesResponse {
    const message = {stacktraces: []};
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {enumerable: false, value: this});
    if (value !== undefined) reflectionMergePartial<StacktracesResponse>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class LocationsRequest$Type extends MessageType<LocationsRequest> {
  ...
  create(value?: PartialMessage<LocationsRequest>): LocationsRequest {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {enumerable: false, value: this});
    if (value !== undefined) reflectionMergePartial<LocationsRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class LocationsResponse$Type extends MessageType<LocationsResponse> {
  ...
  create(value?: PartialMessage<LocationsResponse>): LocationsResponse {
    const message = {locations: []};
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {enumerable: false, value: this});
    if (value !== undefined) reflectionMergePartial<LocationsResponse>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class LocationLinesRequest$Type extends MessageType<LocationLinesRequest> {
  ...
  create(value?: PartialMessage<LocationLinesRequest>): LocationLinesRequest {
    const message = {locationIds: []};
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {enumerable: false, value: this});
    if (value !== undefined) reflectionMergePartial<LocationLinesRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    length: number,
    options: BinaryReadOptions,
    target?: LocationLinesRequest
  ): LocationLinesRequest {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
...
class FunctionsRequest$Type extends MessageType<FunctionsRequest> {
  ...
  create(value?: PartialMessage<FunctionsRequest>): FunctionsRequest {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {enumerable: false, value: this});
    if (value !== undefined) reflectionMergePartial<FunctionsRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class FunctionsResponse$Type extends MessageType<FunctionsResponse> {
  ...
  create(value?: PartialMessage<FunctionsResponse>): FunctionsResponse {
    const message = {functions: []};
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {enumerable: false, value: this});
    if (value !== undefined) reflectionMergePartial<FunctionsResponse>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class MappingsRequest$Type extends MessageType<MappingsRequest> {
  ...
  create(value?: PartialMessage<MappingsRequest>): MappingsRequest {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {enumerable: false, value: this});
    if (value !== undefined) reflectionMergePartial<MappingsRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class MappingsResponse$Type extends MessageType<MappingsResponse> {
  ...
  create(value?: PartialMessage<MappingsResponse>): MappingsResponse {
    const message = {mappings: []};
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {enumerable: false, value: this});
    if (value !== undefined) reflectionMergePartial<MappingsResponse>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class Sample$Type extends MessageType<Sample> {
  constructor() {
    super('parca.metastore.v1alpha1.Sample', [
      ...
      },
      {
        ...
        kind: 'map',
        K: 9 /*ScalarType.STRING*/,
        V: {kind: 'message', T: () => SampleNumLabel},
      },
      {
        no: 4,
        name: 'num_units',
        kind: 'map',
        K: 9 /*ScalarType.STRING*/,
        V: {kind: 'message', T: () => SampleNumUnit},
      },
    ]);
  }
  ...
  private binaryReadMap2(
    ...
    let len = reader.uint32(),
      ...
      key: keyof Sample['labels'] | undefined,
      val: Sample['labels'][any] | undefined;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case 1:
        ...
        default:
          throw new globalThis.Error(
            'unknown map entry field for field parca.metastore.v1alpha1.Sample.labels'
          );
      }
    }
  ...
  private binaryReadMap3(
    map: Sample['numLabels'],
    reader: IBinaryReader,
    options: BinaryReadOptions
  ): void {
    let len = reader.uint32(),
      end = reader.pos + len,
      key: keyof Sample['numLabels'] | undefined,
      val: Sample['numLabels'][any] | undefined;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case 1:
        ...
        default:
          throw new globalThis.Error(
            'unknown map entry field for field parca.metastore.v1alpha1.Sample.num_labels'
          );
      }
    }
  ...
  private binaryReadMap4(
    ...
    let len = reader.uint32(),
      ...
      key: keyof Sample['numUnits'] | undefined,
      val: Sample['numUnits'][any] | undefined;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case 1:
        ...
        default:
          throw new globalThis.Error(
            'unknown map entry field for field parca.metastore.v1alpha1.Sample.num_units'
          );
      }
    }
...
class Stacktrace$Type extends MessageType<Stacktrace> {
  ...
  create(value?: PartialMessage<Stacktrace>): Stacktrace {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {enumerable: false, value: this});
    if (value !== undefined) reflectionMergePartial<Stacktrace>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class SampleLabel$Type extends MessageType<SampleLabel> {
  ...
  create(value?: PartialMessage<SampleLabel>): SampleLabel {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {enumerable: false, value: this});
    if (value !== undefined) reflectionMergePartial<SampleLabel>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class SampleNumLabel$Type extends MessageType<SampleNumLabel> {
  ...
  create(value?: PartialMessage<SampleNumLabel>): SampleNumLabel {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {enumerable: false, value: this});
    if (value !== undefined) reflectionMergePartial<SampleNumLabel>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* repeated int64 num_labels */ 1:
          ...
          else message.numLabels.push(reader.int64().toString());
          break;
        default:
          let u = options.readUnknownField;
          if (u === 'throw')
  ...
  internalBinaryWrite(
    ...
    if (message.numLabels.length) {
      writer.tag(1, WireType.LengthDelimited).fork();
      for (let i = 0; i < message.numLabels.length; i++) writer.int64(message.numLabels[i]);
      writer.join();
    }
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
...
class SampleNumUnit$Type extends MessageType<SampleNumUnit> {
  ...
  create(value?: PartialMessage<SampleNumUnit>): SampleNumUnit {
    const message = {units: []};
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {enumerable: false, value: this});
    if (value !== undefined) reflectionMergePartial<SampleNumUnit>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class Location$Type extends MessageType<Location> {
  ...
  internalBinaryWrite(
    ...
    if (message.id !== '') writer.tag(1, WireType.LengthDelimited).string(message.id);
    /* uint64 address = 2; */
    if (message.address !== '0') writer.tag(2, WireType.Varint).uint64(message.address);
    /* string mapping_id = 4; */
    if (message.mappingId !== '') writer.tag(4, WireType.LengthDelimited).string(message.mappingId);
    /* bool is_folded = 5; */
    if (message.isFolded !== false) writer.tag(5, WireType.Varint).bool(message.isFolded);
    ...
    if (message.mappingIndex !== 0) writer.tag(7, WireType.Varint).uint32(message.mappingIndex);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class Line$Type extends MessageType<Line> {
  ...
  internalBinaryWrite(
    ...
    /* int64 line = 2; */
    if (message.line !== '0') writer.tag(2, WireType.Varint).int64(message.line);
    /* uint32 function_index = 3; */
    if (message.functionIndex !== 0) writer.tag(3, WireType.Varint).uint32(message.functionIndex);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class Function$Type extends MessageType<Function> {
  ...
  create(value?: PartialMessage<Function>): Function {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {enumerable: false, value: this});
    if (value !== undefined) reflectionMergePartial<Function>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(
    ...
    if (message.id !== '') writer.tag(1, WireType.LengthDelimited).string(message.id);
    /* int64 start_line = 2; */
    if (message.startLine !== '0') writer.tag(2, WireType.Varint).int64(message.startLine);
    /* string name = 3; */
    ...
    /* string filename = 5; */
    if (message.filename !== '') writer.tag(5, WireType.LengthDelimited).string(message.filename);
...
class Mapping$Type extends MessageType<Mapping> {
  ...
  create(value?: PartialMessage<Mapping>): Mapping {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {enumerable: false, value: this});
    if (value !== undefined) reflectionMergePartial<Mapping>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(
    ...
    if (message.id !== '') writer.tag(1, WireType.LengthDelimited).string(message.id);
    /* uint64 start = 2; */
    if (message.start !== '0') writer.tag(2, WireType.Varint).uint64(message.start);
    /* uint64 limit = 3; */
    if (message.limit !== '0') writer.tag(3, WireType.Varint).uint64(message.limit);
    /* uint64 offset = 4; */
    if (message.offset !== '0') writer.tag(4, WireType.Varint).uint64(message.offset);
    /* string file = 5; */
    if (message.file !== '') writer.tag(5, WireType.LengthDelimited).string(message.file);
    /* string build_id = 6; */
    if (message.buildId !== '') writer.tag(6, WireType.LengthDelimited).string(message.buildId);
    /* bool has_functions = 7; */
    if (message.hasFunctions !== false) writer.tag(7, WireType.Varint).bool(message.hasFunctions);
    /* bool has_filenames = 8; */
    if (message.hasFilenames !== false) writer.tag(8, WireType.Varint).bool(message.hasFilenames);
