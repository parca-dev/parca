FROM --platform="${BUILDPLATFORM:-linux/amd64}" docker.io/golang:1.18.4-alpine@sha256:615c1c6f969a8f349f8cfdcc2d7ba5fa4df3816fb0c241c0c67e83c42a7aa38d AS builder
