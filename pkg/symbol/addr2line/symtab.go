...
func Symbols(logger log.Logger, filename string, f *elf.File, base uint64, isRawAddresses bool, demangler *demangle.Demangler) (*SymtabLiner, error) {
